...
|--------|------|-------------|
| GET | /api/git/repos | Scan projectsDir for git repos |
| GET | /api/git/diff?dir= | Get diff for directory |
| GET | /api/git/commits?dir=&count= | Get commit log (default 20) |
| GET | /api/git/commits/:hash?dir= | Get diff for specific commit |
