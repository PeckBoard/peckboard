      ...
      <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 520 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-field">
            ...
            <textarea className="form-input" value={context} onChange={(e) => setContext(e.target.value)} placeholder="High-level background and instructions for workers on this project..." rows={3} style={{ resize: 'vertical' }} />
          </div>
          ...
          {showAdvanced && (
            <div className="form-advanced-section">
              <div className="form-field">
                ...
                <p className="form-hint">Number of parallel workers. Keep at 1 unless the repo is set up for parallel work (git worktrees).</p>
              </div>
              <div className="form-field">
              ...
              <div className="form-field">
                ...
                <p className="form-hint">Project-level model override. Cards and workflow steps can further override this.</p>
              </div>
              <div className="form-field">
                ...
                <p className="form-hint">Controls reasoning budget. Higher effort = slower but more thorough.</p>
              </div>
              <div className="form-field">
                ...
                <p className="form-hint">Appends guidance on git worktrees, dependency isolation, and test isolation to worker prompts. Enable when running multiple workers.</p>
              </div>
            </div>
          )}
